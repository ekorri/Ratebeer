...
describe "Beerlist page" do
  ...
  it "by default arranged in alphabetical order by name", :js => true do
    visit beerlist_path
  ...
  it "arranged in alphabetical order by style when style clicked", :js => true do
    visit beerlist_path
    click_link "Style"
  ...
  it "arranged in alphabetical order by brewery when brewery clicked", :js => true do
    visit beerlist_path
    click_link "Brewery"
